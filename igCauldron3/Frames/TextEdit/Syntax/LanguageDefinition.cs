...
namespace igCauldron3.Frames.TextEdit.Syntax;
...
public class LanguageDefinition
{
    ...
    public List<(string, PaletteIndex)> TokenRegexStrings = new List<(string, PaletteIndex)>(); // TODO: Actually use this
    ...
    public static LanguageDefinition TFBScript()
    {
        LanguageDefinition langDef = new("TFBScript")
        {
            Keywords = new[]
            {
            ...
            Identifiers = new[]
            {
                "random", "round", "sin", "cos", "tan", "arcsin", "arccos", "arctan", "sqrt", "abs", "myself", "my", "Add", "Remove", "ReplaceWith", "current", "CollidesWith", "DistanceTo"
            }
        };
